...
export default function Footer() {
  ...
  return (
    <>
      <div className="w-full h-fit p-10 py-5 mt-8 flex flex-col sm:flex-row justify-around items-center " >
        <div className="flex flex-col justify-center items-center sm:w-[20%] w-[80%]" >
          <img
        ...
        <div className="w-[70%] h-fit flex flex-col justify-between " >
...
// <div className="mt-8 grid grid-cols-1 px-80 md:grid-cols-3 w-full">
