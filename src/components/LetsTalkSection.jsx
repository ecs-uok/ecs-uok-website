import { LetsTalkIcon } from "../assets/Icon";
    ...
    <div className="bg-primary h-fit relative py-6 px-10 w-full md:px-48 transition-all duration-1000">
      <div className=" py-6 mt-0 px-3 w-full md:px-10 flex flex-col justify-center">
        ...
        <div className="mt-6 md:flex gap-4">
          <button className="bg-primary mb-2 w-full h-auto md:w-fit md:h-full border-white border-4 text-white text-lg font-bold font-mono rounded-full py-2 px-10 hover:bg-secondary duration-500">
            ecs.uok@gmail.com
          </button>
          <button className="bg-primary w-full h-auto md:w-fit md:h-full border-4 border-white text-white text-lg font-bold font-mono rounded-full py-2 px-6 hover:bg-secondary duration-500">
