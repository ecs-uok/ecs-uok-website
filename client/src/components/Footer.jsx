...
export default function Footer() {
  return (
    <>
      <div className="my-8 px-40 grid grid-cols-3 gap-80">
        <div>
          <img className="h-auto w-full" src={ECSCFooterLogo}></img>
      ...
      <div className="flex gap-20 justify-center items-center my-6">
        ...
        >
          <svg
            ...
            height="1em"
            viewBox="0 0 448 512"
            className="h-10 w-10 fill-black hover:fill-primary duration-500"
          >
        ...
        >
          <svg
            ...
            height="1em"
            viewBox="0 0 320 512"
            className="h-10 w-10 fill-black hover:fill-secondary duration-500"
          >
        ...
        >
          <svg
            ...
            height="1em"
            viewBox="0 0 448 512"
            className="h-10 w-10 fill-black hover:fill-purple-700 duration-500"
          >
        ...
        <a href="https://youtube.com/@ECSCUOK" target="_blank" rel="noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 576 512"
